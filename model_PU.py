...
def SCAM(X):
    ...
    # # conv_band = Multiply()([conv1, channel_attention])
    ...
    #                       padding='valid', kernel_initializer=kernel_init)(conv1)
...
def unet(pretrained_weights=None, input_size=(patch_size, patch_size, 103, 1)):
    ...
    conv0a = MSpaRB(conv00u,filters=[32,32,64],stride=strides111,validkernel=(1,1,4))
    conv0b = MSpeRB(conv00p,filters=[32,32,64],stride=strides111,validkernel=(1,1,4))
    ...
    _conv1 = Conv3D(9, (1,1,1),strides =(1,1,1), activation = 'softmax', padding = 'valid', kernel_initializer = kernel_init, name='out_conv1')(conv_1)
